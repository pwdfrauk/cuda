function openNav(){document.getElementById("mobilenav").style.width="100%",console.log("open nav is cliking")}function clossNav(){document.getElementById("mobilenav").style.width="0%",console.log("mobile nav is closing")}$(document).ready(function(){$(".js--service-section").waypoint(function(n){"down"==n?$("nav").addClass("sticky"):$("nav").removeClass("sticky")});mixitup(".container");$("a").on("click",function(n){var o;""!==this.hash&&(n.preventDefault(),o=this.hash,$("html, body").animate({scrollTop:$(o).offset().top},800,function(){window.location.hash=o}))})});
